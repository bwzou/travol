...
List<Volunteer> volunteers = pageBean.getData();
        //传志愿者过来
%>
...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<meta charset="UTF-8">
	<title>游客天堂</title>
    <script language="javascript" type="text/javascript" src="PageTourist/js/jquery-1.8.0.min.js"></script>
     
	<link rel="stylesheet" media="screen" href="PageTourist/css/root.css">
...
<link rel="stylesheet" href="PageTourist/css/site.css" />
<!--
...
<div class="page-wrapper">
	...
	<section class="intro" id="zen-intro">
		...
		<div class="summary" id="zen-summary" role="article">
			<form id="user_form" action="TouristController?option=selectvol" method="post">  <!-- 查找游客 -->
		...
		<div class="preamble" id="zen-preamble" role="article"><!-- 这里网页div的id也要考虑 -->
			...
			<table width="450" height="100">
				...
				<tr>
					...
					<td height="15"><a href="RatingSystem.jsp?id=<%=vol.getId()%>">评价</a></td>
				</tr>
			</table>
		</div>	
 <%
	...
	<form name="frmGo" id="frmGO" action="VolunteerController?action=getpage" method="post">
	 <p align="center">
		[<%=pageBean.getCurrpage()%>/<%=pageBean.getPagecount()%>] <a
			href="TouristController?option=getpage&page=1">首页</a> | <a
			href="TouristController?option=getpage&page=<%=pageBean.getCurrpage() - 1%>">上一页</a>
		| <a
			href="TouristController?option=getpage&page=<%=pageBean.getCurrpage() + 1%>">下一页</a>
		| <a
			href="TouristController?option=getpage&page=<%=pageBean.getPagecount()%>">末页</a>
			...
			<div class="design-selection" id="design-selection">
				...
				<nav role="navigation">
					...
					<li>
						...
						<a href="/travol/TouristController?option=changePassword&method=forPage">更改密码</a> 
					</li>					
				</ul>
				</nav>
