...
<BODY>
	<form method="post" action="/travol/TouristController?option=regist">
		...
		<DIV
			...
			<P style="padding: 10px 0px 10px; position: relative;">
				...
				<img src="/travol/PageTourist/randomPic.jsp" onclick="changeValidateCode(this)" title="点击图片刷新验证码" />
			</P>
			<DIV
